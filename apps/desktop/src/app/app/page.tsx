...
// TODO: Move attachPlayerUsageTracking to client-safe module or use window.onestar
...
function MediaPlayer({
  ...
  useEffect(() => {
    ...
    // TODO: Re-enable usage tracking after moving to client-safe module
    // Attach usage tracking (licenseId is now always present)
    let cleanupTracking: (() => void) | null = null;

    // Temporarily disabled until usage tracking is moved to client-safe module
    cleanupTracking = () => {}; // Dummy function to satisfy TypeScript
